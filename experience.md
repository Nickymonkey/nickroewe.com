...
education:
  - degree: "BS in Computer Science & Business Administration"
...
<div class="experience-item company-group">
<h3 class="company-name">The Third Floor</h3>
<p class="company-duration">Jan 2019 - Feb 2021</p>
<div class="company-roles">
  <div class="role-item">
    <span class="role-title">Casting Coordinator (Jan 2021 - Feb 2021)</span>
    <span class="role-dates">Los Angeles, CA</span>
  </div>
  <ul>
  <li>Allocated and managed talent across 20+ previs/postvis projects</li>
  </ul>
  <div class="role-item">
    <span class="role-title">Immersive Production Coordinator (Sept. 2019 - Dec. 2020)</span>
    <span class="role-dates">Los Angeles, CA</span>
  </div>
  <ul>
  <li>Managed client & team communications for previs projects with 10-15+ artists for WandaVision, Suicide Squad, Uncharted and more</li>
  </ul>
  <div class="role-item">
    <span class="role-title">Immersive Production Assistant (Mar. 2019 - Sept. 2019)</span>
    <span class="role-dates">Los Angeles, CA</span>
  </div>
  <ul>
  <li>Coordinated between QA, Unity, Animation, and Modeling teams to integrate assets for VR/AR projects</li>
  </ul>
  <div class="role-item">
    <span class="role-title">Immersive Production Intern (Jan. 2019 - Mar. 2019)</span>
    <span class="role-dates">Los Angeles, CA</span>
  </div>
  <ul>
  <li>Integrated assets and animations into Unity</li>
  </ul>
</div>
</div>
